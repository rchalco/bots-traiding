...
namespace cAlgo.Robots
{
    ...
    public class cBotSingleEMA : Robot
    {
        ...
        // ══════════════════════════════════════════════
        //  ESTRATEGIA — EMA 73/159 | Sesión 02–20 UTC
        // ══════════════════════════════════════════════
        [Parameter("EMA Rápida", Group = "Configuración Estrategia", DefaultValue = 73, MinValue = 1)]
        public int EmaFast { get; set; }

        [Parameter("EMA Lenta", Group = "Configuración Estrategia", DefaultValue = 159, MinValue = 1)]
        public int EmaSlow { get; set; }

        [Parameter("Stop Loss (pips)", Group = "Configuración Estrategia", DefaultValue = 6000, MinValue = 1)]
        public int SL { get; set; }

        [Parameter("Take Profit (pips)", Group = "Configuración Estrategia", DefaultValue = 10600, MinValue = 1)]
