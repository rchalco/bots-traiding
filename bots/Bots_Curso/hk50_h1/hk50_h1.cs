...
namespace cAlgo.Robots
{
    ...
    public class cBotSingleEMA : Robot
    {
        ...
        //  VOLUMEN GLOBAL
        // ══════════════════════════════════════════════
        [Parameter("Volumen (Lots)", Group = "General", DefaultValue = 0.3, MinValue = 0.01, Step = 0.01)]
        public double VolumenLots { get; set; }

        // ══════════════════════════════════════════════
        //  ESTRATEGIA — EMA 32/67 | Sesión 02–20 UTC
        // ══════════════════════════════════════════════
        [Parameter("EMA Rápida", Group = "Configuración Estrategia", DefaultValue = 32, MinValue = 1)]
        public int EmaFast { get; set; }

        [Parameter("EMA Lenta", Group = "Configuración Estrategia", DefaultValue = 67, MinValue = 1)]
        public int EmaSlow { get; set; }

        [Parameter("Stop Loss (pips)", Group = "Configuración Estrategia", DefaultValue = 140, MinValue = 1)]
        public int SL { get; set; }

        [Parameter("Take Profit (pips)", Group = "Configuración Estrategia", DefaultValue = 290, MinValue = 1)]
        public int TP { get; set; }

        [Parameter("Hora inicio UTC", Group = "Configuración Estrategia", DefaultValue = 2, MinValue = 0, MaxValue = 23)]
        public int HoraInicio { get; set; }

        [Parameter("Hora fin UTC", Group = "Configuración Estrategia", DefaultValue = 20, MinValue = 0, MaxValue = 23)]
